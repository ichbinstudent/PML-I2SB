...
class MixedPrecisionTrainer:
    ...
    def _optimize_fp16(self, opt: th.optim.Optimizer):
        logger.info("lg_loss_scale: " + str(self.lg_loss_scale))
        ...
        logger.info("param_norm: " + param_norm)
    ...
    def _optimize_normal(self, opt: th.optim.Optimizer):
        ...
        logger.info("grad_norm: " + str(grad_norm))
        logger.info("param_norm: " + str(param_norm))
        opt.step()
        return True
